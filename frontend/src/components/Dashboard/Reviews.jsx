  ...
  const fetchReviews = async () => {
    try {
      const response = await axios.get(
        `/api/v1/reviews/get-user-reviews?page=${page}&sortBy=${sortBy}&sortType=${sortType}`,
        {
  ...
  const updateReview = async (reviewId) => {
    ...
    try {
      const response = await axios.put(
        `/api/v1/reviews/update-review/${reviewId}`,
        formData,
        {
          withCredentials: true,
        }
  ...
  const deleteReview = async (reviewId) => {
    try {
      const response = await axios.delete(
        `/api/v1/reviews/delete-review/${reviewId}`,
        {
          withCredentials: true,
        }
      );
        ...
        {reviewsData.docs.map((review) => (
          ...
          >
            <div className="bg-gray-200 px-3 py-2 rounded-md flex flex-col items-center mb-4">
              <img
                src={review.product.productImages[0]}
