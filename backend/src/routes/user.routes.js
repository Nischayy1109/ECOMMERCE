...
import { loginUser, registerUser,logoutUser, refreshAccessToken, changeCurrentPassword, getCurrentUser, updatePhone, updateCoverImage, requestEmailUpdate, verifyAndUpdateEmail, sendVerificationEmail, verifyUser,generateEmailOTP,verifyOTP, updateFullName } from "../controllers/user.controller.js";
...
router.route("/update-fullname").patch(verifyJWT,updateFullName)//working
